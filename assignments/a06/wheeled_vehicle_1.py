...
####-----------------
#Below is the code added for plot vehicle position
####-----------------
...
while (app.GetDevice().run())  :
    ...
    time_array.append(vehicle.GetChTime())
    vehicle_x.append(vehicle.GetVehiclePos().x)
    vehicle_y.append(vehicle.GetVehiclePos().y)
    vehicle_z.append(vehicle.GetVehiclePos().z)
...
plt.show()
plt.figure()
plt.plot(time_array,vehicle_z)
plt.xlabel('time (s)')
plt.ylabel('vehicle height (m)')
plt.title('Vehicle Height over time')
plt.show()
